...
#Requesting data from web service
...
#converting the dictionary to a list -> data_list
...
fig.update_layout(
    ...
    geo = dict(projection_type="orthographic",
            ...
            showocean = True,
            lakecolor="LightBlue"),
annotations=[dict(text="Source: https://bit.ly/3aEzxjK",
                      showarrow=False,
                      xref="paper",
                      yref="paper",
                      x=0.35,
                      y=0)])
fig.write_html('miniproject.html', auto_open=True)
